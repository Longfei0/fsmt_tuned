...
struct MotionTube{
    ...
    void (*sample)(motion_tube_t*, const motion_primitive_t*, 
        const range_sensor_t*, const pose2d_t*);
    struct{
...
void motion_tube_sample(motion_tube_t*, const motion_primitive_t* motion_primitive,
